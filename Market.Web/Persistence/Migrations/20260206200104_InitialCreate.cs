...
namespace Market.Web.Persistence.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivateIBAN = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCompanyPurchase = table.Column<bool>(type: "boolean", nullable: false),
                    BuyerCompanyName = table.Column<string>(type: "text", nullable: true),
                    BuyerNIP = table.Column<string>(type: "text", nullable: true),
                    BuyerInvoiceAddress = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceAddress_Street = table.Column<string>(type: "text", nullable: false),
                    ...
                    InvoiceAddress_Country = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyProfiles_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfiles_UserProfileId",
